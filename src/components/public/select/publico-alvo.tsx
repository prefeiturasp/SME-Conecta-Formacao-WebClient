...
import { obterPublicoAlvo } from '~/core/services/area-publica-service';
...
const SelectPublicoAlvoPublico: React.FC<SelectPublicoAlvoProps> = ({
  required = true,
  exibirTooltip = true,
  selectProps,
}) => {
...
export default SelectPublicoAlvoPublico;
