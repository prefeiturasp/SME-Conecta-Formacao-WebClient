...
import { BarraCursistasSelecionados } from '~/pages/formacoes/codaf/lista-presenca-codaf/cadastro/componentes/barra-cursistas-selecionados';

interface SecaoListaInscritosProps {
  // Props base (obrigatórias)
  ...
  // Props opcionais — seleção em lote
  ...
  // Props opcionais — divergência de inscritos (módulo homologado)
...
const getBannerText = (
  delta: DeltaInscritosDTO | null | undefined,
...
export const SecaoListaInscritos: React.FC<SecaoListaInscritosProps> = ({
  ...
  const mostrarBarraSelecionados =
    !mostrarDivergencia &&
    quantidadeSelecionados !== undefined &&
    onClickRegistrarDados !== undefined &&
    onClickEditarDados !== undefined;
    ...
    <div>
      ...
      {mostrarBarraSelecionados && (
        <BarraCursistasSelecionados
          ...
          registrarDadosDesabilitado={registrarDadosDesabilitado ?? true}
          editarDadosDesabilitado={editarDadosDesabilitado ?? true}
        />
      )}
          ...
          <Row gutter={[16, 8]} style={{ marginBottom: mostrarListaCancelados ? 0 : 16 }}>
            <Col span={24}>
              ...
              >
                ...
                <Button
                  type='default'
                  icon={<ReloadOutlined style={{ color: '#ff9a52' }} />}
        ...
        <Col span={24}>
          <div className='table-pagination-center'>
            <Table
              ...
              locale={{ emptyText: 'Nenhum cursista cadastrado' }}
