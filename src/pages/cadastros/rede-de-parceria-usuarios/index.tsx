...
import { RedeParceriaUsuariosListaPaginada } from './listagem';

export interface FiltroRedeParceriaUsuariosProps {
...
export const RedeParceriaUsuarios = () => {
  const [form] = useForm();
  const navigate = useNavigate();

  const [filters, setFilters] = useState<FiltroRedeParceriaUsuariosProps>({
    areaPromotora: null,
    nome: null,
    cpf: null,
    situacao: null,
          ...
          <Col span={24}>
            <Row gutter={[8, 8]}>
              ...
              <Col>
                <ButtonPrimary
                  id={CF_BUTTON_NOVO}
                  onClick={() => onClickVoltar({ navigate, route: ROUTES.REDE_PARCERIA_NOVO })}
                >
                  Novo
                </ButtonPrimary>
              </Col>
        ...
        <CardContent>
          <Col span={24}>
            <Row gutter={[16, 8]}>
              ...
              <Col xs={24}>
                <RedeParceriaUsuariosListaPaginada filters={filters} />
              </Col>
            </Row>
          </Col>
        </CardContent>
