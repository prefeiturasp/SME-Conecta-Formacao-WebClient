export const ERRO_LOGIN_SENHA_INCORRETOS = 'Usuário ou senha incorretos';
...
export const ERRO_INFORMAR_LOGIN_RECUPERACAO_SENHA =
  'Você precisa um usuário para recuperação de senha';
export const ERRO_RECUPERACAO_SENHA = 'Erro ao tentar recuperar senha';
export const DESEJA_EXCLUIR_REGISTRO = 'Você tem certeza que deseja excluir este registro?';
export const DESEJA_SALVAR_ALTERACOES_AO_SAIR_DA_PAGINA =
...
export const PROPOSTA_ATRIBUIDA_GRUPO_GESTAO_SUCESSO =
  'Proposta atribuida para validação da gestão com sucesso';
export const PROPOSTA_DEVOLVIDA_SUCESSO = 'Proposta devolvida com sucesso';
export const PROPOSTA_PARECER_SUCESSO = 'Parecer da proposta registrado com sucesso';
