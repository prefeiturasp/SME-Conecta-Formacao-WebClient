...
export const SUA_INSCRICAO_NAO_FOI_ENVIADA = 'Sua inscrição não foi enviada. Deseja enviar agora?';
...
export const SERVICO_INDISPONIVEL_AO_AUTENTICAR = 'Falha ao tentar se autenticar no servidor';
